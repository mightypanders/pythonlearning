...
def main():
	...
	while not done:
		...
		pygame.draw.arc(screen, blue, [200, 200, 200, 200], 3 * PI / 2, 2 * PI,
		                2)
		pygame.draw.arc(screen, black, [200, 200, 200, 200], PI, 3 * PI / 2, 2)

		pygame.draw.polygon(screen, blue, [[400, 200], [200, 100], [200, 200]],
		                    5)
		...
		for y_offset in range(0, 100, 10):
			pygame.draw.line(screen, black, [0, 10 + y_offset],
			                 [100, 110 + y_offset], 10)
		...
		for i in range(200):
			...
			pygame.draw.line(screen, black, [100 + x, 100 + y],
			                 [102 + x, 100 + y], 21)
